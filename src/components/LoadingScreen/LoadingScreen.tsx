...
const LoadingScreen: React.FC<Props> = ({ text, customClassName = "" }) => {
  return (
    <div className="flex justify-center items-center w-full h-full absolute bottom-0 left-0 right-0 top-0 bg-backdrop backdrop-blur-md max-w-[425px] m-auto" style={{ zIndex: 1003 }}>
      <div
