...
const PrayerSchedule = () => {
    ...
    const ContainerPrayer = ({ children }: PropsWithChildren) => (
        <View style={{ backgroundImage: `url(${bgLanding})`, backgroundSize: '400%', backgroundPosition: 'top' }} className='relative bg-no-repeat rounded-b-2xl'>
            <View
              style={{
                    position: 'absolute',
                    top: 0,
                            ...
                            {(data: Prayer, i) => (
                                <View key={data.id} className='py-2 px-4'>
                                    <View
                                      ...
                                      style={{
                                            borderBottom: i === prayerData.length - 1 ? 'none' : '1px solid #EFF1F4',
                                        }}
                                    >
                                        <View className='flex items-center gap-2'>
                                        ...
                                        <View className='flex items-center gap-1'>
                                            ...
                                            {isActive ? (
                                                ...
                                                <span onClick={() => openReminderSetting(data.id, data.status)} className='text-[12px] text-primaryRed'>Atur</span>
                                            ) : (
