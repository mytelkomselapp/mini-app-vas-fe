...
import { useDeleteETicket, useFetchETicketByFlightId, useFetchFlightDetail, useFetchFlightTrack, useFetchFreemiumPackage, useFollowFlight, usePostClaimFreeTicket, useUnfollowFlight } from "../../network";
import { FlightDetailRawData } from "../../network/types/response-props";
import { FreemiumLimitModal } from "../../modules/FlightForm";
// import useToggle from "@/hooks/useToggle";
    ...
    try {
      ...
      if (isTracked) {
        ...
        toast({
          ...
          prefixComponent: <Image src={IconSuccess} style={{ width: '24px', height: '24px' }} />,
          className:
